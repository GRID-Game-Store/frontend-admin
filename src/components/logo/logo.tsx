...
const Logo: React.FC<ILogoProps> = ({ isShowTitle = true }) => {
  return (
    <a href={"/"} style={{ color: "#fff", textDecoration: "none", display: "flex", alignItems: "center", flexDirection: "column"}}>
        <SVGLogo />
        {isShowTitle && <h1 className="scroll-m-20 text-1xl font-extrabold tracking-tight lg:text-2xl ">
        GRID
      </h1>}
    </a>
  );
